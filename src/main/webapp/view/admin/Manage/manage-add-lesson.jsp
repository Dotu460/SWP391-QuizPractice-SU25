<%-- 
    Document   : manage-add-lesson
    Created on : 29 thg 6, 2025, 10:56:33
    Author     : FPT
--%>
...
<head>
    ...
    <title>SkillGro - Add Lesson</title>
    <meta name="description" content="SkillGro - Add Lesson">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12">
                        <div class="form-container">
                            ...
                            <!-- Add Form -->
                            <form action="${pageContext.request.contextPath}/manage-subjects/add-lesson" method="post">
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="content_text" rows="8" placeholder="Enter lesson content here..."></textarea>
