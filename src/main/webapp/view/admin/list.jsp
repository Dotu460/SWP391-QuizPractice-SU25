...
<%--                            <h4 class="title">${tienhoangit}</h4>--%>
                    ...
                    <div class="dashboard__instructor-info-right">
                        <a href="${pageContext.request.contextPath}/subject/new" class="btn btn-two arrow-btn">Create a New Subject <img src="assets/img/icons/right_arrow.svg" alt="img" class="injectable"></a>
                    </div>
                </div>
            </div>
...
<%--                                <h6 class="title">Welcome, ${tienhoangit}</h6>--%>
<%--                            </div>--%>
