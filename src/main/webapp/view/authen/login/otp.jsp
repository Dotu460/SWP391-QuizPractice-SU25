    ...
    <head>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                console.log("Đang kiểm tra ẩn lỗi...")
                ...
                form.addEventListener('submit', function (e) {
                    ...
                    // Không gọi e.preventDefault(); để cho form gửi bình thường
                ...
                window.resendOTP = function () {
                    ...
                    fetch('${pageContext.request.contextPath}/resendOTP', {
                        ...
                        credentials: 'same-origin'
                            ...
                            .then(result => {
                                const [status, timeout] = result.split('/');
                                if (status.trim() === 'success') {
                                    showMessage('success', 'New OTP has been sent to your email', 'fas fa-check-circle');
                                    if (timeout) {
                                        otpTimeoutSeconds = parseInt(timeout);
                                    }
                                    clearInterval(timerInterval);  // Clear timer cũ nếu có
                                    startTimer();
                                } else {
