                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="logo">
                        <a href="${pageContext.request.contextPath}/home">
                            <img src="${pageContext.request.contextPath}/view/common/img/logo/logo.svg" alt="QuizPractice Logo">
                        </a>
                    </div>
                </div>
                                            ...
                                            <ul class="sub-menu mega-menu">
                                                ...
                                                <li>
                                                    <div class="mega-menu-img">
                                                        <a href="courses.html"><img src="view/common/imgimg/others/mega_menu_img.jpg" alt="img"></a>
                                                    </div>
                                                </li>
                                            </ul>
                                        </li>
