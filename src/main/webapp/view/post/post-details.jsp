                        ...
                        <c:if test="${not empty param.success}">
                            <div class="alert alert-success alert-dismissible fade show" role="alert">
                                ...
                                <c:choose>
                                    ...
                                    <c:when test="${param.success == 'post_deleted'}">Post deleted successfully!</c:when>
                        ...
                        <c:if test="${not empty param.error}">
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                ...
                                <c:choose>
                                    ...
                                    <c:when test="${param.error == 'delete_failed'}">Failed to delete post. Please try again.</c:when>
                                    <c:when test="${param.error == 'delete_unauthorized'}">You don't have permission to delete this post.</c:when>
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <div>
                                ...
                                <c:if test="${not isNewPost}">
                                    <button type="button" class="btn btn-danger" onclick="confirmDelete(${post.id})" style="margin-left: 10px;">
...
// Alternative: Using fetch API for AJAX delete
function deletePostAjax(postId) {
    ...
    .then(response => {
        if (response.ok) {
            ...
            window.location.href = '${pageContext.request.contextPath}/blog?success=post_deleted';
        } else {
